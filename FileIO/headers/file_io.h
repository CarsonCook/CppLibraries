...
public:
    ...
    FileInput &operator=(FileInput &&Ref) noexcept;
...
public:
    ///constructors and destructors
    explicit FileOutput(const char *filePath); //will create file if it does not exist
    ...
    FileOutput &operator=(FileOutput &&Ref) noexcept;
