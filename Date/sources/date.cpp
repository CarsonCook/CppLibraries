...
Date::Date(Date&& other) noexcept{
    ...
    this->setMonth(other.mMonth);
    this->setYear(other.mYear);

    //nullify other's values
    other.setDay(DEFAULT_DAY);
    other.setMonth(DEFAULT_MONTH);
    other.setYear(DEFAULT_YEAR);
    other.setDayType(DayOfWeek::NOT_SET);
}
